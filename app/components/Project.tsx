...
const Project = ({ poster, name, projectLink, github, description, moreDetails, delay}
  ...
  return (
    <AnimatedContainer delay={delay} slideLeft yMargin='-10%' className='group'>
      <div onClick={handleClick} className='cursor-pointer p-3 lg:p-4 rounded-lg flex flex-col md:flex-row gap-6 lg:gap-8 items-start group  group-hover:translate-x-1 transition-all'>
